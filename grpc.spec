...
Source0  : https://github.com/grpc/grpc/archive/v1.66.1/grpc-1.66.1.tar.gz
...
%prep
%setup -q -n grpc-1.66.1
cd %{_builddir}
tar xf %{_sourcedir}/opencensus-proto-0.3.0.tar.gz
cd %{_builddir}/grpc-1.66.1
mkdir -p third_party/opencensus-proto
cp -r %{_builddir}/opencensus-proto-0.3.0/* %{_builddir}/grpc-1.66.1/third_party/opencensus-proto
%patch -P 1 -p1
pushd ..
cp -a grpc-1.66.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724882383
mkdir -p clr-build
pushd clr-build
...
/V3/usr/lib64/libgrpc++.so.1.66.1
/V3/usr/lib64/libgrpc++_alts.so.1.66.1
/V3/usr/lib64/libgrpc++_error_details.so.1.66.1
/V3/usr/lib64/libgrpc++_reflection.so.1.66.1
/V3/usr/lib64/libgrpc++_unsecure.so.1.66.1
/V3/usr/lib64/libgrpc.so.43.0.0
/V3/usr/lib64/libgrpc_authorization_provider.so.1.66.1
/V3/usr/lib64/libgrpc_plugin_support.so.1.66.1
/V3/usr/lib64/libgrpc_unsecure.so.43.0.0
/V3/usr/lib64/libgrpcpp_channelz.so.1.66.1
