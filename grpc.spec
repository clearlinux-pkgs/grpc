...
Source0  : https://github.com/grpc/grpc/archive/v1.70.0/grpc-1.70.0.tar.gz
...
cp -r %{_builddir}/opencensus-proto-0.3.0/* %{_builddir}/grpc-1.70.0/third_party/opencensus-proto
%patch -P 1 -p1
pushd ..
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737649749
mkdir -p clr-build
pushd clr-build
...
/V3/usr/lib64/libgrpc++.so.1.70.0
/V3/usr/lib64/libgrpc++_alts.so.1.70.0
/V3/usr/lib64/libgrpc++_error_details.so.1.70.0
/V3/usr/lib64/libgrpc++_reflection.so.1.70.0
/V3/usr/lib64/libgrpc++_unsecure.so.1.70.0
/V3/usr/lib64/libgrpc.so.45.0.0
/V3/usr/lib64/libgrpc_authorization_provider.so.1.70.0
/V3/usr/lib64/libgrpc_plugin_support.so.1.70.0
/V3/usr/lib64/libgrpc_unsecure.so.45.0.0
/V3/usr/lib64/libgrpcpp_channelz.so.1.70.0
